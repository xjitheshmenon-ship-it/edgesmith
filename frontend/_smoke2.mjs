...
const routes = ['/reports','/shifts','/job-assignment','/job-execution','/config','/master-lists','/tempering','/employees','/users']
...
for (const rt of routes) {
  ...
  await page.goto(base+rt, { waitUntil:'domcontentloaded' }).catch(e=>errs.push('GOTO '+e))
